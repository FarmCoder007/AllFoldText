...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        textView_status.setText(mCollapsed ? "全部" : "收起");
...
//        textView_status.setVisibility(View.VISIBLE);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.mipmap.detail_arrow_down);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.mipmap.detail_arrow_up);
        }
    ...
    private void findViews() {
        ...
        LinearLayout layout = (LinearLayout) findViewById(R.id.expand_child_layout);
        layout.setOnClickListener(this);
        mButton = (ImageButton) layout.findViewById(R.id.expand_collapse);
        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        mButton.setOnClickListener(this);

        textView_status = (TextView) layout.findViewById(R.id.toggle_btn);
        textView_status.setText(mCollapsed ? "全部" : "收起");
